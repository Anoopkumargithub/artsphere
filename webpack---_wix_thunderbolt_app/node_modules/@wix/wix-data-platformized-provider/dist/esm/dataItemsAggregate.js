export default function toDataItemsAggregate(platformizedAggregation) {
    ...
    const getItemFieldName = (operation) => {
        ...
        return typeof operationField === 'string' && operationField.startsWith('$') ? operationField.substring(1) : operationField;
    };
    const operations = typeof platformizedAggregation === 'object' ? Object.keys(platformizedAggregation).filter(projectedField => typeof platformizedAggregation[projectedField] === 'object' && projectedField !== '_id').map(projectedField => {
