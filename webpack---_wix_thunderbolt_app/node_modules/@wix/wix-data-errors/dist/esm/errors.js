...
export const messages = {
    ...
    keyTooLargeToIndex: () => 'WDE0010: Document field is too large to index.',
    ...
    schemaDoesNotExist: (collectionName) => `WDE0025: The ${collectionName} collection does not exist. You cannot work with a collection using the Data API before it is created in the Editor.`,
    collectionDeleted: (collectionName) => `WDE0026: The ${collectionName} collection was removed, so you cannot work with it. To restore its data, create a new collection with the same name.`,
    permissionDenied: (action, collectionName) => `WDE0027: The current user does not have permissions to ${action} on the ${collectionName} collection.`,
    requestTimedOut: () => `WDE0028: Operation time limit exceeded.`,
    ...
    filterTreeValidationsAjv: {
        objectType: (operatorName) => `WDE0056: ${operatorName} should be an Object. Got \${0} instead`,
        arrayType: (operatorName) => `WDE0057: ${operatorName} should be an Array. Got \${0} instead`,
        arrayLength: (operatorName, expectedLength) => `WDE0057: \${0}.length is \${0/length}. ${operatorName} Array should have length ${expectedLength}`,
        comparisonOperatorType: (operatorName) => `WDE0058: ${operatorName} should be a Date, Number, or String. Got \${0} instead`,
        stringOperatorType: (operatorName) => `WDE0059: ${operatorName} should be a String. Got \${0} instead`,
        setOperatorItems: (operatorName) => `WDE0060: ${operatorName} Array should only contain values of types Date, Number, and String. Got \${0} instead`,
        inOperatorItems: () => `WDE0061: $in Array should have length 2, and match [String, Number]. Got \${0} instead`,
        matchesOperatorRequiredProperty: (propertyName) => `WDE0062: $matches value \${0} does not have property ${propertyName}`,
    ...
    tooManyRequests: () => 'WDE0014: Requests per minute quota exceeded.',
    processingTimeQuotaExceeded: () => 'WDE0122: Processing time quota exceeded.',
    operationNotSupported: (collectionName, operation) => `${collectionName} does not support ${operation} operation.`,
    ...
    invalidLimit: (maxLimit) => `WDE0077: 'limit' cannot exceed ${maxLimit}`,
    datasetTooLargeToSort: () => 'WDE0092: Dataset is too large to sort.',
    invalidIdForSingleItemCollection: (collectionName, expectedId, receivedId) => `WDE0079: [${collectionName}] is a single item collection and item must have id [${expectedId}], but got [${receivedId}] instead.`,
    ...
    cannotSortMultipleArrayFields: () => 'WDE0121: Sorting by multiple array fields is not supported',
};
export const codes = {
...
export const DATA_HOOK_ERROR_NAME = 'WixDataHookError';
...
export function dataHookError(err) {
    ...
    const errorInstance = new Error(stringify(buildObj(err)));
...
function WixDataError(message) {
    const errorInstance = new UserCodeError(message);
    Object.setPrototypeOf(errorInstance, Object.getPrototypeOf(this));
    if (Error.captureStackTrace) {
