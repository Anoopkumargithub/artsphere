...
var GalleryContainer = /** @class */ (function(_super) {
    ...
    GalleryContainer.prototype.getVisibleItems = function(items, container, isPrerenderMode) {
        var _a, _b;
        var gotFirstScrollEvent = this.state.gotFirstScrollEvent;
        var scrollY = ((_b = (_a = this.state) === null || _a === void 0 ? void 0 : _a.scrollPosition) === null || _b === void 0 ? void 0 : _b.top) || 0;
        var galleryHeight = container.galleryHeight,
            scrollBase = container.scrollBase,
            galleryWidth = container.galleryWidth;
        if (isPrerenderMode || // (used to be isSSR, had a hydrate bug, isPrerenderMode is the way to go in terms of hydrate issues)
            isSEOMode() ||
            isEditMode() ||
            gotFirstScrollEvent ||
            scrollY > 0 ||
