...
var SlideshowView = /** @class */ (function(_super) {
    ...
    SlideshowView.prototype.isAllItemsLoaded = function() {
        ...
        var visibleItemsCount = getVisibleItems(galleryStructure.galleryItems, container, isPrerenderMode).length;
    ...
    SlideshowView.prototype.getBufferedItems = function(galleryGroups, container) {
        ...
        var groups = getVisibleItems(galleryGroups, container, isPrerenderMode);
