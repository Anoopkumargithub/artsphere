...
var Sentry = function(t) {
    ...
    function E(t, n) {
        try {
            for (var r = t, i = [], e = 0, o = 0, u = " > ".length, a = void 0; r && e++ < 5 && !("html" === (a = _(r, n)) || e > 1 && o + i.length * u + a.length >= 80);) i.push(a), o += a.length, r = r.parentNode;
    ...
    var k = function(t) {
            function n(n) {
                ...
                return i.message = n, i.name = r.prototype.constructor.name, j(i, r.prototype), i
            }
            return r(n, t), n
        }(Error),
        S = /^(?:(\w+):)\/\/(?:(\w+)(?::(\w+))?@)([\w.-]+)(?::(\d+))?\/(.+)/;
    ...
    function J(t) {
        ...
        if (b(t)) {
            ...
            o.type = e.type;
            try {
                o.target = w(e.target) ? E(e.target) : Object.prototype.toString.call(e.target)
            } catch (t) {
                o.target = "<unknown>"
            }
            try {
                o.currentTarget = w(e.currentTarget) ? E(e.currentTarget) : Object.prototype.toString.call(e.currentTarget)
            } catch (t) {
    ...
    function K(t, n) {
        return "domain" === n && t && "object" == typeof t && t.i ? "[Domain]" : "domainEmitter" === n ? "[DomainEmitter]" : "undefined" != typeof global && t === global ? "[Global]" : "undefined" != typeof window && t === window ? "[Window]" : "undefined" != typeof document && t === document ? "[Document]" : m(r = t) && "nativeEvent" in r && "preventDefault" in r && "stopPropagation" in r ? "[SyntheticEvent]" : "number" == typeof t && t != t ? "[NaN]" : void 0 === t ? "[undefined]" : "function" == typeof t ? "[Function: " + U(t) + "]" : "symbol" == typeof t ? "[" + String(t) + "]" : "bigint" == typeof t ? "[BigInt: " + String(t) + "]" : t;
        var r
    }

    function V(t, n, r, i) {
        var e, o;
        void 0 === r && (r = 1 / 0), void 0 === i && (e = "function" == typeof WeakSet, o = e ? new WeakSet : [], i = [function(t) {
    ...
    function at(t) {
        if (!ut[t]) switch (ut[t] = !0, t) {
            case "console":
                ! function() {
                    if (!("console" in et)) return;
                    ["debug", "info", "warn", "error", "log", "assert"].forEach((function(t) {
                        t in et.console && X(et.console, t, (function(n) {
                            return function() {
            ...
            case "dom":
                ! function() {
                    ...
                    var t = st.bind(null, "dom"),
                        n = lt(t, !0);
                    et.document.addEventListener("click", n, !1), et.document.addEventListener("keypress", n, !1), ["EventTarget", "Node"].forEach((function(n) {
                        var r = et[n] && et[n].prototype;
                        r && r.hasOwnProperty && r.hasOwnProperty("addEventListener") && (X(r, "addEventListener", (function(n) {
                ...
                ! function() {
                    ...
                    X(t, "open", (function(t) {
                        return function() {
                            ...
                            return "onreadystatechange" in i && "function" == typeof i.onreadystatechange ? X(i, "onreadystatechange", (function(t) {
                                return function() {
                                    for (var n = [], r = 0; r < arguments.length; r++) n[r] = arguments[r];
                ...
                ! function() {
                    if (! function() {
                            ...
                            if (r && "function" == typeof r.createElement) try {
                                ...
                                i.hidden = !0, r.head.appendChild(i), i.contentWindow && i.contentWindow.fetch && (n = nt(i.contentWindow.fetch)), r.head.removeChild(i)
                            } catch (t) {}
                            return n
                        }()) return;
                    X(et, "fetch", (function(t) {
                        return function() {
                            ...
                            return st("fetch", e({}, i)), t.apply(et, n).then((function(t) {
                                return st("fetch", e(e({}, i), {
                                    endTimestamp: Date.now(),
                                    response: t
                                })), t
                            }), (function(t) {
                                throw st("fetch", e(e({}, i), {
                                    endTimestamp: Date.now(),
                                    error: t
                                })), t
                            }))
            ...
            case "history":
                ! function() {
                    ...
                    }, X(et.history, "pushState", n), X(et.history, "replaceState", n)
                }();
                break;
            case "error":
                pt = et.onerror, et.onerror = function(t, n, r, i, e) {
                    return st("error", {
                        column: i,
                        error: e,
                        line: r,
            ...
            case "unhandledrejection":
                yt = et.onunhandledrejection, et.onunhandledrejection = function(t) {
                    return st("unhandledrejection", t), !yt || yt.apply(this, arguments)
                };
                break;
            default:
    ...
    function ft(t) {
        return void 0 === t && (t = []), "Request" in et && x(t[0], Request) && t[0].method ? String(t[0].method).toUpperCase() : t[1] && t[1].method ? String(t[1].method).toUpperCase() : "GET"
    }

    function ht(t) {
        return void 0 === t && (t = []), "string" == typeof t[0] ? t[0] : "Request" in et && x(t[0], Request) ? t[0].url : String(t[0])
    }
    var vt, dt;
            ...
            function(r) {
                if (r && dt !== r && ! function(t) {
                    ...
                    (void 0 === vt || function(t, n) {
                        ...
                        name: i,
                        global: n
                    }), dt = r), clearTimeout(vt), vt = et.setTimeout((function() {
                        vt = void 0
                    }), 1e3)
                }
            }
    ...
    function Ot(t) {
        ...
        return {
            $: n,
            add: function(i) {
                if (!(void 0 === t || n.length < t)) return kt(new k("Not adding Promise due to buffer limit reached."));
                var e = i();
    ...
    var Ct = function() {
        function t() {
            this.g = !1, this._ = [], this.j = [], this.k = [], this.S = {}, this.O = {}, this.T = {}, this.D = {}, this.R = {}
        }
        return t.clone = function(n) {
            var r = new t;
            return n && (r.k = a(n.k), r.O = e({}, n.O), r.T = e({}, n.T), r.D = e({}, n.D), r.S = n.S, r.N = n.N, r.I = n.I, r.M = n.M, r.q = n.q, r.A = n.A, r.j = a(n.j), r.C = n.C), r
        }, t.prototype.addScopeListener = function(t) {
            this._.push(t)
        }, t.prototype.addEventProcessor = function(t) {
            return this.j.push(t), this
        }, t.prototype.setUser = function(t) {
            return this.S = t || {}, this.M && this.M.update({
                user: t
            }), this.L(), this
            ...
            var r;
            return this.O = e(e({}, this.O), ((r = {})[t] = n, r)), this.L(), this
        }, t.prototype.setExtras = function(t) {
            return this.T = e(e({}, this.T), t), this.L(), this
        }, t.prototype.setExtra = function(t, n) {
            var r;
            return this.T = e(e({}, this.T), ((r = {})[t] = n, r)), this.L(), this
            ...
            var r;
            return null === n ? delete this.D[t] : this.D = e(e({}, this.D), ((r = {})[t] = n, r)), this.L(), this
            ...
            return n instanceof t ? (this.O = e(e({}, this.O), n.O), this.T = e(e({}, this.T), n.T), this.D = e(e({}, this.D), n.D), n.S && Object.keys(n.S).length && (this.S = n.S), n.N && (this.N = n.N), n.A && (this.A = n.A), n.C && (this.C = n.C)) : m(n) && (n = n, this.O = e(e({}, this.O), n.tags), this.T = e(e({}, this.T), n.extra), this.D = e(e({}, this.D), n.contexts), n.user && (this.S = n.user), n.level && (this.N = n.level), n.fingerprint && (this.A = n.fingerprint), n.requestSession && (this.C = n.requestSession)), this
        }, t.prototype.clear = function() {
            return this.k = [], this.O = {}, this.T = {}, this.S = {}, this.D = {}, this.N = void 0, this.q = void 0, this.A = void 0, this.C = void 0, this.I = void 0, this.M = void 0, this.L(), this
            ...
            return this.U(t), t.breadcrumbs = a(t.breadcrumbs || [], this.k), t.breadcrumbs = t.breadcrumbs.length > 0 ? t.breadcrumbs : void 0, t.sdkProcessingMetadata = this.R, this.H(a(Lt(), this.j), t, n)
        }, t.prototype.setSDKProcessingMetadata = function(t) {
            return this.R = e(e({}, this.R), t), this
        }, t.prototype.H = function(t, n, r, i) {
            var o = this;
            return void 0 === i && (i = 0), new St((function(u, a) {
                var c = t[i];
                if (null === n || "function" != typeof c) u(n);
                    ...
                    })).then(null, a) : o.H(t, s, r, i + 1).then(u).then(null, a)
                }
            }))
    ...
    var Ht = function() {
            function t(t) {
                this.errors = 0, this.sid = mt(), this.duration = 0, this.status = "ok", this.init = !0, this.ignoreDuration = !1;
                var n = Mt();
                this.timestamp = n, this.started = n, t && this.update(t)
            }
            return t.prototype.update = function(t) {
                if (void 0 === t && (t = {}), t.user && (!this.ipAddress && t.user.ip_address && (this.ipAddress = t.user.ip_address), this.did || t.did || (this.did = t.user.id || t.user.email || t.user.username)), this.timestamp = t.timestamp || Mt(), t.ignoreDuration && (this.ignoreDuration = t.ignoreDuration), t.sid && (this.sid = 32 === t.sid.length ? t.sid : mt()), void 0 !== t.init && (this.init = t.init), !this.did && t.did && (this.did = "" + t.did), "number" == typeof t.started && (this.started = t.started), this.ignoreDuration) this.duration = void 0;
        ...
        Ft = function() {
            function t(t, n, r) {
                void 0 === n && (n = new Ct), void 0 === r && (r = 4), this.F = r, this.P = [{}], this.getStackTop().scope = n, t && this.bindClient(t)
            }
            return t.prototype.isOlderThan = function(t) {
                ...
                return "transaction" !== t.type && (this.X = r), this.B("captureEvent", t, e(e({}, n), {
                    event_id: r
                })), r
    ...
    function Bt() {
        var t, n = Pt();
        return (t = n) && t.__SENTRY__ && t.__SENTRY__.hub && !Wt(n).isOlderThan(4) || $t(n, new Ft), Wt(n)
    }

    function Wt(t) {
        return t && t.__SENTRY__ && t.__SENTRY__.hub || (t.__SENTRY__ = t.__SENTRY__ || {}, t.__SENTRY__.hub = new Ft), t.__SENTRY__.hub
    }
    ...
    function nn(t) {
        ...
        return function(t) {
            ...
            })), tn(r)) : "function" == typeof r && (i = r(i), i = Array.isArray(i) ? i : [i]);
            ...
            n[t.name] = t,
                function(t) {
                    -1 === Zt.indexOf(t.name) && (t.setupOnce(Ut, Bt), Zt.push(t.name), A.log("Integration installed: " + t.name))
                }(t)
        })), B(n, "initialized", !0), n
    }
    var rn = "Not capturing exception because it's already been captured.",
        en = function() {
            ...
            return t.prototype.captureException = function(t, n, r) {
                ...
                if (!_t(t)) {
                    var e = n && n.event_id;
                    return this.tt(this.nt().eventFromException(t, n).then((function(t) {
                        return i.rt(t, n, r)
                    })).then((function(t) {
                        e = t
                    }))), e
                ...
                return this.tt(u.then((function(t) {
                    return e.rt(t, r, i)
                })).then((function(t) {
                    o = t
                }))), o
                ...
                if (!(n && n.originalException && _t(n.originalException))) {
                    var i = n && n.event_id;
                    return this.tt(this.rt(t, n, r).then((function(t) {
                        i = t
                    }))), i
                }
                A.log(rn)
                ...
                var s = jt(a);
                return c && (s = c.applyToEvent(a, r)), s.then((function(t) {
                ...
                if (!t) return null;
                var r = e(e(e(e(e({}, t), t.breadcrumbs && {
                ...
                return t.contexts && t.contexts.trace && (r.contexts.trace = t.contexts.trace), t.sdkProcessingMetadata = e(e({}, t.sdkProcessingMetadata), {
                ...
                var n = this.getOptions(),
                    ...
                    o = n.maxValueLength,
                    u = void 0 === o ? 250 : o;
                "environment" in t || (t.environment = "environment" in n ? r : "production"), void 0 === t.release && void 0 !== i && (t.release = i), void 0 === t.dist && void 0 !== e && (t.dist = e), t.message && (t.message = H(t.message, u));
                ...
                return this.vt(t, n, r).then((function(t) {
                    return t.event_id
                }), (function(t) {
                    A.error(t)
                }))
                ...
                if (!this.it()) return kt(new k("SDK not enabled, will not capture event."));
                var s = "transaction" === t.type;
                return !s && "number" == typeof u && Math.random() > u ? (c("sample_rate", "event"), kt(new k("Discarding event because it's not included in the random sample (sampling rate = " + u + ")"))) : this.at(t, r, n).then((function(r) {
                    if (null === r) throw c("event_processor", t.type || "event"), new k("An event processor returned null, will not send event.");
                    return n && n.data && !0 === n.data.__sentry__ || s || !o ? r : function(t) {
                    ...
                    if (null === n) throw c("before_send", t.type || "event"), new k("`beforeSend` returned `null`, will not send event.");
    ...
    var on = function() {
        ...
        un = function() {
            function t(t) {
                this.Y = t, this.Y.dsn || A.warn("No DSN provided, backend will not do anything."), this.dt = this.lt()
            }
    ...
    function cn(t, n) {
        ...
        var v = {
            body: r,
            type: o,
            url: u ? Yt(n.dsn, n.tunnel) : Qt(n.dsn)
        };
        if (u) {
            var d = qt(e(e({
                event_id: t.event_id,
    ...
    var sn, fn = "6.18.2",
        ...
        dn = function() {
            ...
            return t.prototype.setupOnce = function() {
                ...
                return !!this.wt(t, n) || (!!this.gt(t, n) || (!!this.xt(t, n) || !this.Et(t, n)))
                ...
                return void 0 === t && (t = {}), {
                    allowUrls: a(this.Y.whitelistUrls || [], this.Y.allowUrls || [], t.whitelistUrls || [], t.allowUrls || []),
                    denyUrls: a(this.Y.blacklistUrls || [], this.Y.denyUrls || [], t.blacklistUrls || [], t.denyUrls || []),
                    ignoreErrors: a(this.Y.ignoreErrors || [], t.ignoreErrors || [], vn),
    ...
    var mn = /^\s*at (?:(.*?) ?\((?:address at )?)?((?:file|https?|blob|chrome-extension|address|native|eval|webpack|<anonymous>|[-a-z]+:|.*bundle|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,
        ...
        gn = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:file|https?|blob|chrome|webpack|resource|moz-extension|capacitor).*?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. /=]+)(?::(\d+))?(?::(\d+))?\s*$/i,
        ...
        _n = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i,
        jn = [40, function(t) {
            var n = _n.exec(t);
        ...
        On = / line (\d+), column (\d+)\s*(?:in (?:<anonymous function: ([^>]+)>|([^)]+))\(.*\))? in (.*):\s*$/i,
        Tn = [20, function(t) {
            var n = On.exec(t);
        ...
        try {
            return function() {
                ...
                return function(t, n) {
                    ...
                    var c = [];
                    try {
                        for (var s = o(t.split("\n").slice(n)), f = s.next(); !f.done; f = s.next()) {
                            var h = f.value;
                            try {
    ...
    function An(n, r, i) {
        ...
        return Et(e), e.level = t.Severity.Error, r && r.event_id && (e.event_id = r.event_id), jt(e)
    }
    ...
    function Ln(t, n, r, i) {
        ...
        return h(t) ? Nn(t) : m(t) || b(t) ? (o = function(t, n, r) {
            var i = {
                exception: {
                    values: [{
                        type: b(t) ? t.constructor.name : r ? "UnhandledRejection" : "Error",
                        value: "Non-Error " + (r ? "promise rejection" : "exception") + " captured with keys: " + Y(t)
                    }]
                },
                extra: {
                    __serialized__: G(t)
    ...
    function Xn(t, n) {
        if ("[object Navigator]" === Object.prototype.toString.call(Fn && Fn.navigator) && "function" == typeof Fn.navigator.sendBeacon) return Fn.navigator.sendBeacon.bind(Fn.navigator)(t, n);
        if (tt()) {
            var r = Pn();
            r(t, {
                body: n,
    ...
    var Wn = s(),
        $n = function() {
            function t(t) {
                var n, r, i, e = this;
                this.options = t, this.St = Ot(30), this.Ot = {}, this.Tt = {}, this.Dt = (n = t.dsn, r = t.Rt, i = t.tunnel, {
                    initDsn: n,
                    metadata: r || {},
                    dsn: D(n),
                    tunnel: i
                }), this.url = Qt(this.Dt.dsn), this.options.sendClientReports && Wn.document && Wn.document.addEventListener("visibilitychange", (function() {
            ...
            return t.prototype.sendEvent = function(t) {
                ...
                if (this.options.sendClientReports) {
                    var i = Bn(n) + ":" + t;
                    A.log("Adding outcome: " + i), this.Tt[i] = (null != (r = this.Tt[i]) ? r : 0) + 1
                }
            }, t.prototype.Nt = function() {
                if (this.options.sendClientReports) {
                    var t = this.Tt;
                    if (this.Tt = {}, Object.keys(t).length) {
                        ...
                        var n, r, i, e = Yt(this.Dt.dsn, this.Dt.tunnel),
                            ...
                            a = (n = o, qt((r = this.Dt.tunnel && O(this.Dt.dsn)) ? {
                                dsn: r
                            } : {}, [
                                [{
                                    type: "client_report"
                ...
                var n, r = t.response,
                    ...
                    e = t.resolve,
                    o = t.reject,
                    u = (n = r.status) >= 200 && n < 300 ? "success" : 429 === n ? "rate_limit" : n >= 400 && n < 500 ? "invalid" : n >= 500 ? "failed" : "unknown";
                this.qt(i);
                "success" !== u ? o(r) : e({
                    status: u
                })
                    ...
                    try {
                        for (var s = o(a.trim().split(",")), f = s.next(); !f.done; f = s.next()) {
                            var h = f.value.split(":", 2),
                                ...
                                d = 1e3 * (isNaN(v) ? 60 : v);
                            try {
                                for (var l = (i = void 0, o(h[1].split(";"))), p = l.next(); !p.done; p = l.next()) {
                                    var y = p.value;
                ...
                return !!c && (this.Ot.all = new Date(u + function(t, n) {
                    void 0 === n && (n = Date.now());
                    var r = parseInt("" + t, 10);
        ...
        Jn = function(t) {
            ...
            return r(n, t), n.prototype.It = function(t, n) {
                var r = this;
                if (this.Ct(t.type)) return this.recordLostEvent("ratelimit_backoff", t.type), Promise.reject({
                    event: n,
                    type: t.type,
                    reason: "Transport for " + t.type + " requests locked till " + this.At(t.type) + " due to too many requests.",
                    status: 429
                });
                var i = {
                    body: t.body,
                ...
                return void 0 !== this.options.fetchParameters && Object.assign(i, this.options.fetchParameters), void 0 !== this.options.headers && (i.headers = this.options.headers), this.St.add((function() {
                    return new St((function(n, e) {
                        r.Lt(t.url, i).then((function(i) {
                            var o = {
                    ...
                    throw n instanceof k ? r.recordLostEvent("queue_overflow", t.type) : r.recordLostEvent("network_error", t.type), n
                }))
            }, n
        }($n),
        zn = function(t) {
            ...
            return r(n, t), n.prototype.It = function(t, n) {
                var r = this;
                return this.Ct(t.type) ? (this.recordLostEvent("ratelimit_backoff", t.type), Promise.reject({
                    event: n,
                    type: t.type,
                    reason: "Transport for " + t.type + " requests locked till " + this.At(t.type) + " due to too many requests.",
                    status: 429
        ...
        Kn = function(n) {
            ...
            return r(i, n), i.prototype.eventFromException = function(t, n) {
                ...
                return void 0 === r && (r = t.Severity.Info), Cn(n, r, i, this.Y.attachStacktrace)
                ...
                return this.Y.transport ? new this.Y.transport(t) : tt() ? new Jn(t) : new zn(t)
            }, i
        }(un),
        Vn = s(),
        Qn = 0;
    ...
    function tr(t, n, r) {
        ...
        var sentryWrapped = function() {
            ...
            try {
                ...
                throw Zn(), zt((function(r) {
                    r.addEventProcessor((function(t) {
                        return n.mechanism && (xt(t, void 0, void 0), Et(t, n.mechanism)), t.extra = e(e({}, t.extra), {
                            arguments: i
                        }), t
                    })), captureException(t)
                })), t
        ...
        ct("error", (function(n) {
            ...
            if (i.getIntegration(rr)) {
                ...
                if (!(Yn() || f && f.__sentry_own_request__)) {
                    ...
                    }(o, a, c, s) : or(Ln(f || o, void 0, e, !1), a, c, s);
    ...
    var sr = ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"],
        fr = function() {
            function t(n) {
                this.name = t.id, this.Y = e({
                    XMLHttpRequest: !0,
                    eventTarget: !0,
            ...
            return t.prototype.setupOnce = function() {
                var t = s();
                this.Y.setTimeout && X(t, "setTimeout", hr), this.Y.setInterval && X(t, "setInterval", hr), this.Y.requestAnimationFrame && X(t, "requestAnimationFrame", vr), this.Y.XMLHttpRequest && "XMLHttpRequest" in t && X(XMLHttpRequest.prototype, "send", dr);
    ...
    function dr(t) {
        return function() {
            ...
            return e.forEach((function(t) {
                t in i && "function" == typeof i[t] && X(i, t, (function(n) {
                    var r = {
                            mechanism: {
                                data: {
                                    function: t,
    ...
    function lr(t) {
        ...
        r && r.hasOwnProperty && r.hasOwnProperty("addEventListener") && (X(r, "addEventListener", (function(n) {
            return function(r, i, e) {
                try {
                    "function" == typeof i.handleEvent && (i.handleEvent = tr(i.handleEvent.bind(i), {
                        mechanism: {
                            data: {
    ...
    var pr = function() {
        ...
        return t.prototype.addSentryBreadcrumb = function(t) {
            this.Y.sentry && Bt().addBreadcrumb({
            ...
            this.Y.console && ct("console", yr), this.Y.dom && ct("dom", function(t) {
                function n(n) {
                ...
                return n
            }(this.Y.dom)), this.Y.xhr && ct("xhr", mr), this.Y.fetch && ct("fetch", br), this.Y.history && ct("history", wr)
        }, t.id = "Breadcrumbs", t
    }();
    ...
    function yr(t) {
        ...
        if ("assert" === t.level) {
            ...
            n.message = "Assertion failed: " + (F(t.args.slice(1), " ") || "console.assert"), n.data.arguments = t.args.slice(1)
        }
        Bt().addBreadcrumb(n, {
            input: t.args,
            level: t.level
    ...
    function br(n) {
        n.endTimestamp && (n.fetchData.url.match(/sentry_key/) && "POST" === n.fetchData.method || (n.error ? Bt().addBreadcrumb({
            category: "fetch",
            data: n.fetchData,
    ...
    function wr(t) {
        var n = s(),
            ...
            o = bt(r),
            u = bt(i);
        o.path || (o = e), e.protocol === u.protocol && e.host === u.host && (i = u.relative), e.protocol === o.protocol && e.host === o.host && (r = o.relative), Bt().addBreadcrumb({
            category: "navigation",
            data: {
                from: r,
                to: i
    ...
    var gr = function() {
        function t(n) {
            void 0 === n && (n = {}), this.name = t.id, this.Ht = n.key || "cause", this.Ft = n.limit || 5
        }
        return t.prototype.setupOnce = function() {
            Ut((function(n, r) {
            ...
            return t.prototype.setupOnce = function() {
                Ut((function(n) {
                    if (Bt().getIntegration(t)) {
                        ...
                        var r = n.request && n.request.url || Er.location && Er.location.href,
                    ...
                    if (i) {
                        try {
                            if (function(t, n) {
                                    ...
                                    return !1
                                }(n, i.Pt)) return A.warn("Event dropped due to being a duplicate of previously captured event."), null
                        } catch (t) {
                            return i.Pt = n
                        }
                        return i.Pt = n
    ...
    var Dr = Object.freeze({
        ...
        Rr = function(t) {
            function n(n) {
                void 0 === n && (n = {});
                return n.Rt = n.Rt || {}, n.Rt.sdk = n.Rt.sdk || {
    ...
    return t.BrowserClient = Rr, t.Hub = Ft, t.Integrations = Ar, t.SDK_NAME = "sentry.javascript.browser", t.SDK_VERSION = fn, t.Scope = Ct, t.Session = Ht, t.Transports = Gn, t.addBreadcrumb = function(t) {
        Jt("addBreadcrumb", t)
    }, t.addGlobalEventProcessor = Ut, t.captureEvent = function(t) {
        ...
        Jt("configureScope", t)
    }, t.defaultIntegrations = Nr, t.eventFromException = An, t.eventFromMessage = Cn, t.flush = function(t) {
        var n = Bt().getClient();
        return n ? n.flush(t) : jt(!1)
    }, t.forceLoad = function() {}, t.getCurrentHub = Bt, t.getHubFromCarrier = Wt, t.init = function(t) {
        ...
        void 0 === t.autoSessionTracking && (t.autoSessionTracking = !0), void 0 === t.sendClientReports && (t.sendClientReports = !0),
            function(t, n) {
                ...
                Ir(t), ct("history", (function(t) {
                    var n = t.from,
                        r = t.to;
                    void 0 !== n && n !== r && Ir(Bt())
                }))
            }()
    }, t.injectReportDialog = nr, t.lastEventId = function() {
        return Bt().lastEventId()
    }, t.makeMain = Xt, t.onLoad = function(t) {
        t()
    ...
    }, t.withScope = zt, t.wrap = function(t) {
        return tr(t)()
    }, t
}({});
