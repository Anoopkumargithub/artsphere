        ...
        var e, t = {
                    ...
                    function A(e, t, r = {}) {
                        if (e) {
                            const {
                                ...
                                displayMode: i,
                                aspectRatio: u
                            } = r, f = u || ("stretch" === i ? "none" : "xMidYMid meet");
                            let h = e.match(p) ? .[0];
                            if (!h) return e;
                            e = c.test(h) ? e.replace(h, h.replace(c, `$1${f}$3`)) : e.replace(/<svg/, `<svg preserveAspectRatio="${f}"`), s.test(h) || (n === v.UGC && o && (e = e.replace(/<svg/, `<svg viewBox="${o}"`)), n !== v.UGC && a && (e = e.replace(/<svg/, `<svg viewBox="${a}"`))), n !== v.UGC && !l && a && (h = e.match(p)[0], e = e.replace(h, h.replace(s, `$1${a}$3`)))
                        }
                        return e
                    }
                    const x = {
                ...
                7102: function(e, t, r) {
                    ...
                    function a({
                        ...
                        return `<filter id="${e}" color-interpolation-filters="sRGB" ${function(e){return Object.keys(e).map((t=>o(t,e[t]))).join(" ")}(r)}>\n    <feComponentTransfer result="srcRGB"/>\n    ${t}\n    <feComponentTransfer/>\n</filter>`
                    }
                    ...
                    function i({
                        ...
                        return `<feColorMatrix type="matrix" values="${(0,n.getColor)((0,n.hex2RgbNorm)(o),a)}" ${t?`in="${t}"`:""}${r?`result="${r}"`:""}/>`
                    }
                    ...
                    const c = {
                            ...
                            brightness: function({
                                ...
                                return `<feComponentTransfer ${o("result",t)}>${(0,n.getBrightness)(e)}</feComponentTransfer>`
                            },
                            sepia: function({
                                value: e
                            }) {
                            ...
                            alpha: function({
                                ...
                                return `<feComponentTransfer ${o("in",t)} ${o("result",r)}>${(0,n.getAlpha)(e)}</feComponentTransfer>`
                            }
                        },
                        f = {
                            blend: function({
                                ...
                                return `<feBlend mode="${e}" in="${t}" in2="${r}" ${o("result",n)}/>`
                            },
                            color: i,
                            composite: function({
                                value: e,
                                ...
                                return `<feComposite operator="${e}" in="${t}" in2="${r}" ${o("result",n)}/>`
                            },
                            tint: function({
                                value: e
                            }) {
                        ...
                        h = {
                            duotone: function({
                                ...
                                return `${l({value:0})}\n<feColorMatrix type="matrix" values="${(0,n.getDoutone)((0,n.hex2RgbNorm)(t),(0,n.hex2RgbNorm)(e))}" ${r?`in="${r}"`:""}${o?`result="${o}"`:""}/>`
                            },
                            shadow: function({
                                value: {
                                    blurRadius: e,
                    ...
                    t.interpolate = function(e, t, r, l) {
                        return a({
                            id: e,
                            content: t.map((e => {
                                const {
                                ...
                                return "number" == typeof l ? c[t](i) : "string" == typeof l ? f[t](i) : "luma" === t ? function({
                                    value: {
                                        dark: e,
                                        light: t
                                    },
                                    ...
                                    return `<feColorMatrix type="matrix" values="${(0,n.getLumaMatrix)(t,e)}" ${r?`result="${r}"`:""}/>`
                ...
                6719: function(e, t, r) {
                    ...
                    const A = (e, t) => {
                        ...
                        x = (0, v.S)((e => {
                            ...
                            return {
                                get src() {
                                    return f.userSrc || (e = o.svgId, t = o.altText, `wix:vector://v1/${e}/${t?encodeURIComponent(t):""}`);
                                    var e, t
                                },
                                set src(e) {
                                    p({
                                    ...
                                    const {
                                        type: a
                                    } = h(e, o.mediaSvgUrl), i = [l, u].includes(a);
                                    r((e => e ? {
                                        "--stroke-width": "unset",
                                        "--stroke": "unset"
                                    } : {})(i)), t(d(e, o.mediaSvgUrl, s.sanitizeSVG).then((e => ((e, t, r, o, a) => {
                                        if (e === l) return {
                                            svgContent: t,
                                            shouldScaleStroke: r
                                        };
                                        ...
                                        return {
                                            svgContent: A(t, o),
                                            shouldScaleStroke: r || a && "ugc" === i.svgType
                                        }
                                    })(a, e, i, o, c.fixVectorImageShouldScaleStroke))))
                                },
                                toJSON() {
                                    const {
                                        src: e
                ...
                5349: function(e, t, r) {
                    ...
                    l.rgb.hsl = function(e) {
                        ...
                        var t, r, n, o, a, l, i, u = e[0] / 360,
                            ...
                            c = e[2] / 100,
                            f = s + c;
                        switch (f > 1 && (s /= f, c /= f), n = 6 * u - (t = Math.floor(6 * u)), 1 & t && (n = 1 - n), o = s + n * ((r = 1 - c) - s), t) {
                            default:
                                case 6:
                                case 0:
                                a = r,
...
//# sourceMappingURL=https://static.parastorage.com/services/editor-elements-library/dist/corvid/rb_wixui.corvid[VectorImage].b6d98299.bundle.min.js.map