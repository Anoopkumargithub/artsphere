    ...
    [5097], {
        49828: function(t, e, i) {
            ...
            class l {
                constructor(t, e, i) {
                    this.isResponsive = e, this.breakpointRanges = [], this.animator = t, this.definitions = {}, this.scrubScenes = {}, this.scrubTriggers = {}, this.callbacks = {}, this.sessionState = {
                        played: new Map,
                        running: new WeakMap
                    }, this.scrubManagers = [], this.activeListeners = [], this.disabledPointerScenes = {}, this.variantValidator = i, this.breakpointChangeHandler = this._breakpointChangeHandler.bind(this)
                }
                ...
                updateScrubScenes(t, e = !1) {
                    ...
                    this.scrubScenes = Object.assign(this.scrubScenes, this.animator.createScrubAnimations(i))
                }
                        ...
                        t instanceof h.g && t.config.scenes.forEach((t => {
                            if (t.target && t.centeredToTarget && t.isHitAreaRoot) {
                                const e = t.target.closest("[data-block-level-container]"),
                                    i = t.effectId;
                                e && this.motionViewport && i && (this.disabledPointerScenes[i] || (this.disabledPointerScenes[i] = []), this.disabledPointerScenes[i].push(t), this.motionViewport.observe(e, {
                                    effectId: i,
                ...
                trigger(t = {}, e) {
                    let i = 0;
                    t.scrub ? e ? (this.scrubTriggers = t.scrub, requestAnimationFrame((() => this.updateScrubManagers(t.scrub, e)))) : (Object.assign(this.scrubTriggers, t.scrub), this.updateScrubManagers(t.scrub)) : i = this.isResponsive ? window.innerWidth : 0, t.play ? .length && t.play.forEach((({
                        effectId: t,
                        targetId: e
                    }) => {
                        const n = this._getEffectVariationForCurrentBreakpoint(t, i);
                        n.name && this.playAnimation(n, t, {
                            targetId: e
                        })
                        ...
                        const n = this._getEffectVariationForCurrentBreakpoint(t, i);
                        n.name && this.resumeOrPlayAnimation(n, t, {
                            targetId: e
                        })
                ...
                playAnimation(t, e, i = {}) {
                    const n = { ...t,
                        ...
                        a = d(s);
                    this._shouldSkipPlayedAnimation(a) ? this.setAnimationStartState(s) : 0 !== r ? this._createAndRunSequence(n, e) : this.observeTargetPlaybackInViewport(e, s)
                }
                    ...
                    const {
                        ...
                        callbacks: {
                            onStart: t => {
                                ...
                                i && (this._addAnimatingClass(i), this.sessionState.running.set(i, t)), e && this.callbacks[e] ? .start ? .forEach((t => t({
                                    compId: n
                                })))
                            },
                            onComplete: () => {
                ...
                observeBreakpointChange() {
                    this.breakpointRanges.forEach((t => {
                        ...
                        this.activeListeners.push(i), i.addEventListener("change", this.breakpointChangeHandler)
                    }))
                }
            ...
            const g = function(t, e, i) {
                    return i && this.definitions[e].findLast((t => t.variants ? .some((t => !(t.max && t.max < i) && !(t.min && t.min > i))))) || t
                },
                m = (0, n.Og)([(0, n.KT)(s.Gp, c.UU), (0, n.KT)(s.wk, c.UU), r.Is, a.RV, o.n, (0, n.lq)(f.Qw)], ((t, e, i, n, s, r) => {
                    const a = new Promise((n => {
                        ...
                        r && !s || n(void 0), r.getEffectsInstance().then((t => {
                                ...
                                const e = {
                                        ...
                                        exit: n((function(e) {
                                            const n = e.filter((t => {
                                                ...
                                                return e || (i.get(n).isIntersecting = !1), !e
                                            })).flatMap((t => s(t.target)));
                                            t.trigger({
                                                hold: n
                                            })
                                ...
                                return {
                                    observe: function(n, s) {
                                        ...
                                        r ? (r.effects.add(s), r.isIntersecting && t.trigger({
                                            ...
                                            effects: new Set([s]),
                                            isIntersecting: !1
                                        }), e.entry.observe(n), e.exit.observe(n))
                                    },
                                    disconnect: function() {
        ...
        3040: function(t, e, i) {
            ...
            function r(t, e) {
                s.x = window.scrollX, s.y = window.scrollY, requestAnimationFrame((() => t && t(e)))
            }
            ...
            function o(t) {
                ...
                return t.scenes.forEach((e => {
                    ...
                    }(t) : (o = a.bind(null, t), window.addEventListener("resize", o))
                })), e = function(e) {
                    for (let i of t.scenes)
                        if (!i.disabled) {
                            const s = +n(0, 1, i.transform ? .x(e.x) || e.x / t.rect.width).toPrecision(4),
                    ...
                    Object.assign(d, e)
                }, h && (c = r.bind(null, e, d), document.addEventListener("scrollend", c)), {
                    tick: e,
                    destroy: function() {
                        t.scenes.forEach((t => t.destroy ? .())), document.removeEventListener("scrollend", c), i ? (i.disconnect(), i = null) : (window.removeEventListener("resize", o), o = null), e = null, d = null
                    }
                }
            }
            class c {
