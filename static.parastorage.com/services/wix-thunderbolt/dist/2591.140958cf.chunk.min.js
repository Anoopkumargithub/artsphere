    ...
    [2591], {
        8242: function(t, e, i) {
            ...
            function s(t, e, i) {
                ...
                let h, d;
                return "entry" === o ? (h = s - e, d = Math.min(e, c)) : "contain" === o ? (h = Math.min(r - e, s), d = Math.abs(e - c)) : "exit" === o ? (h = Math.max(s, r - e), d = Math.min(e, c)) : "cover" === o && (h = s - e, d = c + e), h + f * d | 0
            }
            ...
            function h(t, e, i, o, h) {
                ...
                for (; w;) {
                    ...
                    const t = window.getComputedStyle(w),
                        ...
                        n = i ? f(t, o) : void 0,
                        s = c(w, o, i);
                    n && "end" in n || (p += s), x.push({
                        element: w,
                        offset: s,
                        sticky: n
                    }), w = w.offsetParent, w || (v = "fixed" === t.position)
                }
                x.reverse();
                const b = function(t, e, i, o, r) {
                    ...
                    let d, a = c,
                        ...
                        l = t.startRange,
                        w = t.endRange;
                    if ("string" == typeof h) l = {
                        name: h,
                        offset: 0
                    }, w = {
                        name: h,
                        offset: 100
                    }, a = s(l, i, e), u = s(w, i, e), d = u - a;
                    else {
                        if (l || c ? .name) {
                            l = l || c;
                            const t = n(l.add, r);
                ...
                return x.forEach(((t, e) => {
                    ...
                    if (n) {
                        if ("end" in n) {
                            ...
                            if (s) {
                                const e = ((o ? t.element.offsetWidth : t.element.offsetHeight) || 0) + n.end - i,
                                    s = y + e - t.offset,
                                    r = s < b.start,
                                    c = !r && s <= b.end;
                                let f = 0;
                                (r || c) && (f = t.offset, b.end += f), r && (b.start += f)
                            }
                        }
                        if ("start" in n) {
                            const i = y - n.start,
                            ...
                            if (f) {
                                if (s || r) {
                                    c = ((o ? f.offsetWidth : f.offsetHeight) || 0) - (t.offset + ((o ? t.element.offsetWidth : t.element.offsetHeight) || 0)), y += c, b.end += c
                                }
                                s && (b.start += c)
                            }
                        }
            ...
            function a(t, e, i, o) {
                let n = 0;
                return t >= e && t <= i ? n = o ? (t - e) / o : 1 : t > i && (n = 1), n
            }
            ...
            function l(t) {
                const e = o(t, d),
                    ...
                    n = e.horizontal,
                    s = new WeakMap;
                let r, c, f, l, w, p = u(i, n);
                const v = [],
                    g = {
                        viewportWidth: window.visualViewport.width,
                        viewportHeight: window.visualViewport.height
                    };
                if (e.scenes = t.scenes.map(((t, o) => (t.index = o, t.viewSource && ("string" == typeof t.duration || t.start ? .name) ? (t = h(t, i, p, n, g), e.observeSourcesResize && v.push(t)) : null == t.end && (t.end = t.start + t.duration), null == t.duration && (t.duration = t.end - t.start), t))), v.length) {
                    if (window.ResizeObserver) {
                        const t = new Map;
                        f = new window.ResizeObserver((function(o) {
                            o.forEach((o => {
                                const s = t.get(o.target);
                                e.scenes[s.index] = h(s, i, p, n, g), v.splice(v.indexOf(s), 1, e.scenes[s.index])
                            }))
                        })), v.forEach((e => {
                            f.observe(e.viewSource, {
                                box: "border-box"
                ...
                return e.observeViewportEntry && window.IntersectionObserver && (c = new window.IntersectionObserver((function(t) {
                    ...
                    if (t.viewSource) {
                        ...
                        e || (e = [], s.set(t.viewSource, e), c.observe(t.viewSource)), e.push(t)
                    }
                }))), {
                    tick: function({
                        p: t,
                    ...
                    destroy: function() {
                        e.scenes.forEach((t => t.destroy ? .())), c && (c.disconnect(), c = null), f && (f.disconnect(), f = null), l && (w ? (w.disconnect(), w = null) : (window.visualViewport || window).removeEventListener("resize", l))
                    }
                }
            }
            const w = {
            ...
            class p {
                constructor(t = {}) {
                    this.config = o(t, w), this.progress = {
                        p: 0,
                        prevP: 0,
                        vp: 0
                ...
                resetProgress(t = {}) {
                    ...
                    this.progress.p = n, this.progress.prevP = n, this.progress.vp = 0, this.config.transitionActive && (this.currentProgress.p = n, this.currentProgress.prevP = n, this.currentProgress.vp = 0), t && this.config.root.scrollTo(i, o)
                }
                tick(t) {
        ...
        3040: function(t, e, i) {
            ...
            function s(t, e) {
                n.x = window.scrollX, n.y = window.scrollY, requestAnimationFrame((() => t && t(e)))
            }
            ...
            function c(t) {
                ...
                return t.scenes.forEach((e => {
                    var o, s;
                    e.target && e.centeredToTarget && (e.transform = (o = function(t) {
                        let e = t,
                            i = 0,
                            o = 0;
                        if (e.offsetParent)
                            do {
                                i += e.offsetLeft, o += e.offsetTop, e = e.offsetParent
                            } while (e);
                        return {
                            left: i,
                            top: o,
                    ...
                    }(t) : (c = r.bind(null, t), window.addEventListener("resize", c))
                })), e = function(e) {
                    for (let i of t.scenes)
                        if (!i.disabled) {
                            const n = +o(0, 1, i.transform ? .x(e.x) || e.x / t.rect.width).toPrecision(4),
                                s = +o(0, 1, i.transform ? .y(e.y) || e.y / t.rect.height).toPrecision(4),
                                r = {
                                    x: e.vx,
                                    y: e.vy
                                };
                    ...
                    Object.assign(d, e)
                }, h && (f = s.bind(null, e, d), document.addEventListener("scrollend", f)), {
                    tick: e,
                    destroy: function() {
                        t.scenes.forEach((t => t.destroy ? .())), document.removeEventListener("scrollend", f), i ? (i.disconnect(), i = null) : (window.removeEventListener("resize", c), c = null), e = null, d = null
                    }
                }
            }
            class f {
