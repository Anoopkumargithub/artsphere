    ...
    [5503], {
        60563: function(e, t, n) {
            ...
            var b = n(78691),
                _ = n(79460),
                v = n(51360);
            const I = (0, a.Og)([(0, a.KT)(o.YG, p.UU), i.RV, l.F, r.$1, p.nk, p.u_, c.t7, b._w, _.q, u.n], (({
                ...
                async handle(r) {
                    if (!r.pageId && r.relativeUrl && r.parsedUrl && r.relativeEncodedUrl) {
                        ...
                        const U = await (() => {
                            ...
                            return !d["specs.thunderbolt.dynamicPagesWarmupData2"] || e ? null : c.getWarmupData(p.UU, {
                                timeout: 0
                            })
                        })();
                        if (U) return { ...r,
                        ...
                        if (d["specs.thunderbolt.DPRPagesGet"] && !(0, s.fU)(n)) try {
                            ...
                            const n = await async function(e) {
                                ...
                                return new Promise(((e, t) => {
                                    ...
                                    n.onloadend = () => e(n.result.split(",")[1]), n.onerror = t, n.readAsDataURL(r)
                                }))
                            }({
                                urlParams: t,
            ...
            var R = n(16537),
                S = n(94715),
                D = n(12457);
            const T = (0, a.Og)([(0, a.KT)(o.YG, p.UU), i.RV, S.wN, D.Tf, u.n, i.UK], (({
                externalBaseUrl: e
            }, t, n, a, r, o) => ({
                async handleResponse(n, r) {
                    ...
                    return n.then((async n => {
                        ...
                        const P = (({
                            ...
                            page: t,
                            redirectUrl: n
                        }, a) => a ? h : 403 === e ? d : 404 === e ? g : t || n ? null : m)(c, u);
                        return P ? { ...r,
                            pageId: P
                        } : ((e, t) => {
                            const {
            ...
            var M = n(19889),
                $ = n(66397);
            const k = (0, a.Og)([(0, a.KT)(o.wk, p.UU), r.Ix, c.t7, (0, a.lq)(M.Np)], ((e, t, n, a) => {
                    const r = async (e, r) => {
                        const {
                            success: s,
                            reason: o
                        ...
                        return o === $.qd.CANCELED && n.isLandingOnProtectedPage() ? t.navigate("./") : !!s && t.navigate(r.parsedUrl.href)
                    };
                    return e.update((() => ({
                        handlePermissions: r,
                ...
                O = e => {
                    e(r.po.Dynamic, o.SV).to(I), e(p.nk).to(T), e(p.P3, R.$.AppWillMountHandler).to(k), e(p.u_).to(E)
                }
        },
            ...
            const l = (0, o.Og)([(0, o.KT)(r.Gp, i.U), s.eZ, s.Ji], ((e, t, n) => ({
                    ...
                    pageWillMount(a) {
                        ((e, t, n, a) => {
                            ...
                            l && (i[e] ? (l.components.includes(r) || n.addComponentToParent(s, r, o), a.update({
                                [s]: {
                                    className: "page-with-sosp"
                                }
                            })) : (l.components.includes(r) && n.removeComponentFromParent(s, r), a.update({
                                [s]: {
