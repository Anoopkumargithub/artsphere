...
function shouldTrack(force) {
    return (force ||
        (!(0, env_1.isWebWorker)() &&
            (0, env_1.isBackoffice)() &&
            (0, env_1.getWindowIfTop)(function(window) {
                return !window[IS_TRACKING];
            })));
}

function setIsTracking() {
    return (0, env_1.getWindowIfTop)(function(window) {
...
function trackBrowsingSession(loggerFactory) {
    ...
    (0, navigator_1.listen)(function(fromUrl, toUrl) {
        var _a = (0, env_1.getWindowIfTop)(function(window) {
                return ({
                    sr: (0, browser_1.getDesktopSize)(window),
                    wr: (0, browser_1.getWindowSize)(window),
                });
            }),
            sr = _a.sr,
            wr = _a.wr;
