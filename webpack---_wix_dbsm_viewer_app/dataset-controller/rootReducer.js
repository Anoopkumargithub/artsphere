...
export const isCursorPagingRequired = state =>
    config.isCursorPagingRequired(state.config)
...
export const getUserFilterConnectionProps = state =>
    config.getUserFilterConnectionProps(state.config)
...
export const selectSetFilterCalled = state =>
    records.selectSetFilterCalled(state.records)
...
export const getUserFilterInitialData = state =>
    records.getUserFilterInitialData(state.records)
export const selectIsApplyUserInputFiltersActionBindingPresent = state =>
    records.selectIsApplyUserInputFiltersActionBindingPresent(state.records)