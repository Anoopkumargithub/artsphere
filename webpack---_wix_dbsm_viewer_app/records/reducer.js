...
const initialRecordsState = {
    ...
    isApplyUserInputFiltersActionBindingPresent: false,
}
...
const isApplyUserInputFiltersActionBindingPresent = connections =>
    connections.some(
        connection =>
        get(connection, 'config.events.onClick.action') ===
        'applyUserInputFilters',
    )
...
const reducer = (state = initialRecordsState, action) => {
    switch (action.type) {
        ...
        case rootActions.actionTypes.INIT:
            {
                ...
                return {
                    ...
                    isApplyUserInputFiltersActionBindingPresent: isApplyUserInputFiltersActionBindingPresent(connections),
                }
            }
        ...
        case actionTypes.SET_USER_INPUT_OPTION_VALUES:
            {
                return {
                    ...state,
                    userFilterInitialData: action.userFilterInitialData,
                }
            }
...
export default {
    ...
    selectSetFilterCalled: state => state.setFilterCalled,
    ...
    getUserFilterInitialData: state => state.userFilterInitialData,

    selectIsApplyUserInputFiltersActionBindingPresent: state =>
        state.isApplyUserInputFiltersActionBindingPresent,
}