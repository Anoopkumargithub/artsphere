...
const getScreenHeight = (heightOverride) => heightOverride ||
    ...
    window.innerHeight ||
    0;
const getImageComputedProperties = (extendedImageInfo, envConsts, htmlTag, allowWEBPTransform) => {
    ...
    const imageOptions = Object.assign(pick(imageData, ['upscaleMethod', 'hasAnimation']), pick(extendedImageInfo, 'filters'), extendedImageInfo.quality || imageData.quality, allowWEBPTransform && {
        allowWEBPTransform
    });
