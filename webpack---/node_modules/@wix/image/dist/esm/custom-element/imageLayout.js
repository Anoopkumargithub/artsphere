...
function measure(id, measures, domNodes, {
    ...
    const {
        width,
        height
    } = services.getMediaDimensionsByEffect ? .(bgEffect, sourceOfDimensions.offsetWidth, sourceOfDimensions.offsetHeight, screenHeight) || {
...
function patch(id, measures, domNodes, imageInfo, services, envConsts, loadImage, isResponsive, bgEffect) {
    ...
    const allowWEBPTransform = services.isExperimentOpen ? .('specs.thunderbolt.allowWEBPTransformation') && isTransformedWEBP(image, imageData.uri);
